...
void Renderer::changeViews(float x, float y){
    xPos = x;
    yPos = y;
}
...
extern "C" {
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_init(JNIEnv* env, jclass clazz);
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_resize(JNIEnv* env, jclass clazz, jint width, jint height);
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_step(JNIEnv* env, jclass clazz);
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_nativeSetResPath(JNIEnv* jenv, jclass clazz, jstring path);
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_rebuildingLights(JNIEnv* env, jclass clazz, jint num);  // 참고 | 라이트 개수 조절용
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_notifyObservers(JNIEnv* env, jclass clazz);
JNIEXPORT void JNICALL Java_com_android_gles3jni_GLES3JNILib_changeViews(JNIEnv* env, jclass clazz, jfloat x, jfloat y);
};
...
Java_com_android_gles3jni_GLES3JNILib_init(JNIEnv* env, jclass clazz) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
    ...
    g_renderer = createTiledShadingRenderer(); //modified
...
extern "C" JNIEXPORT void JNICALL
Java_com_android_gles3jni_GLES3JNILib_resize(JNIEnv* env, jclass clazz, jint width, jint height) {
    if (g_renderer) {
        g_renderer->resize(width, height);
    }
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_android_gles3jni_GLES3JNILib_step(JNIEnv* env, jclass clazz) {
    if (g_renderer) {
        g_renderer->render();
    }
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_android_gles3jni_GLES3JNILib_nativeSetResPath(JNIEnv* jenv, jclass clazz, jstring path)
{
...
// 참고 | 라이트 개수 조절용, 미완성
extern "C" JNIEXPORT void JNICALL
Java_com_android_gles3jni_GLES3JNILib_rebuildingLights(JNIEnv* env, jclass clazz, jint num) {
    if (g_renderer) {
        g_renderer->rebuildingLights(num);
    }
}
extern "C" JNIEXPORT void JNICALL
Java_com_android_gles3jni_GLES3JNILib_changeViews(JNIEnv* env, jclass clazz, jfloat x, jfloat y) {
    if (g_renderer) {
        g_renderer->changeViews(x, y);
    }
}
#endif
